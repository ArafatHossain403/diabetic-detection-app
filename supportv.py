...
st.subheader('Model Test Accuracy Score using Support Vector Machine ')
st.write(str(accuracy_score(Y_test, vector.predict(X_test)) * 100)+'%')
prediction = vector.predict(user_input)
